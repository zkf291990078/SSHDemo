				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td><input type="text" name="cust_name" id="cust_name"  value="<s:property value='#linkMan.customer.cust_name' />" style="WIDTH: 180px"/></td>
								<td><input type="hidden" name="cust_id" id="cust_id" value="<s:property value='#linkMan.customer.cust_id' />"/></td>
								<td><input type="button" value="选择" onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list?select=true','','width=600,height=300')"/> </td>
							</tr>
							<TR>
								<td>联系人名称：</td>
								<td>
